...
El repositorio contiene UnitTests, FunctionalTests, IntegrationTests y EndToEndTests. La CI ejecuta la solución, usa Docker para Testcontainers y prepara Chromium para Playwright. La última ejecución manual confirmada para este cierre registró **195 pruebas correctas y 0 fallidas**.
