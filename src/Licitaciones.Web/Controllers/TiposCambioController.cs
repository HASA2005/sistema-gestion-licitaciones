...
public sealed class TiposCambioController(TipoCambioService s) : Controller
{
    ...
    private static string ObtenerMensajeActivacion(Exception excepcion) =>
        excepcion is DbUpdateException or InvalidOperationException
            ? "Ya existe un tipo de cambio activo. Desactive el tipo de cambio actual antes de activar este registro."
            : excepcion.Message;
}
